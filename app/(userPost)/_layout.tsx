...
import CreatePostScreen from "../(post)/create";
import PostDetailsScreen from "../(post)/(details)/[postId]";
import MyPostsScreen from "../(userPost)";
import EditPostScreen from "./(edit)/[myPostId]";
    ...
    return (
        <SafeAreaView style={{ backgroundColor: "#6B46C1" }}>
            <View className="h-16 flex-row items-center justify-between px-4">
                <TouchableOpacity
                    onPress={() =>
                        isCreatePostScreen ? navigation.navigate("Home") : navigation.toggleDrawer()
                    }
                >
                    <Ionicons
                ...
                <Text className="text-lg font-semibold text-white">
                    {isCreatePostScreen ? "Create Post" : "Posts"}
                </Text>
                <View style={{ width: 28 }} />
            </View>
        </SafeAreaView>
